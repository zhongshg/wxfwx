...
<header class="u-header">
  <div class="l"> <a href="javascript:history.go(-1)" class="J_backToPrev"><span class="u-icon"><img src="images/kj_15.png" width="15"/></span></a> </div>
  <div class="u-hd-tit"><span>商家详情</span></div>
    ...
    <div id="banner_box" class="box_swipe">
      <ul style="list-style: none outside none; transition-duration: 500ms;">
      	<%-- <c:forEach items="${imgs }" var="image"> --%>
       	 <li> <a onClick="return false;"> <img src="${pageContext.servletContext.contextPath}${store.img }" alt="2" style="width:100%;"> </a> </li>
        <%-- </c:forEach> --%>
        <!-- <li> <a onClick="return false;"> <img src="images/200.jpg" alt="2" style="width:100%;"> </a> </li> -->
      </ul>
    </div>
  </div>
  <script>
  ...
  <div class="orderdeatilbox clearfix">
    <div class="orderdeatil clearfix">
      <div class="user_orderlist_r">
        ...
        <p><span class="fl" onclick="javascript:window.location.href='guide.jsp?lon=${store.jing}&lat=${store.wei}'"><img src="images/kj_19.png" width="16" onclick=""/> &nbsp;&nbsp;${store.area }</span></p>
      </div>
    </div>
  </div>
  <div class="orderdeatilbox clearfix border_t">
    <p class="qx_p"> <a class="" href="tel:${store.tel }"><img src="images/kj_18.png" width="30"/></a> 
    <a class="dzf_zhifu" href="isscore.jsp?tid=${store.id }">我要评论</a></p>
  </div>
</div>
...
<div id="tab" style="margin-top:20px">
  ...
  <div class="tabCon">
    ...
    <div>
      <table style="width:100%;border:0;cellspacing:0;bgcolor:#FFFFFF;cellpadding:0;"  class="py">
      </table>
    </div>
  </div>
</div>
<!-- 商铺详情 结束 -->
	...
	function eachData(data){
		if(data.length >= 1 ){
			$.each(data,function(index,array){ 
				...
				str += " </td></tr><tr><td height=\"57\"><span class=\"an\">评语:</span>"+array.content+"</td>"; 
	...
	<%-- function guide(){
		var origin = '我的位置';
		var dest = '${store.area }';
		var url = "http://api.map.baidu.com/direction?origin=latlng:<%=lat%>,<%=lon%>|name:" + origin;
		url += "&destination=latlng:'${store.wei}','${store.jing}'|name:"+dest+"&mode=driving&region='<%=adf.getString("name")%>'&output=html&src='看见味道'";
		console.log(url);
