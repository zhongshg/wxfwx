...
<html>
    ...
    <%
        int pnum = RequestUtil.getInt(request, "pnum");
    %>
    <script>
//新版微信支付
            ...
            function(res) {
                if (res.err_msg == "get_brand_wcpay_request:ok") {
                    window.setTimeout(function() {
                        location.replace("${pageContext.servletContext.contextPath}/ForeServlet?method=lingyang&act=2&openid=${jsapimap.openid}&targetopenid=${jsapimap.targetopenid}&pnum=${param.pnum}")
//                        window.location.replace("${pageContext.servletContext.contextPath}/dog/shop.jsp?openid=${jsapimap.openid}&targetopenid=${jsapimap.targetopenid}");
                        //跳转支付成功页面！
                    }, 1500);
