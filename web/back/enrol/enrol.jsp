        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $("#exeall").click(function() {
                    ...
                    if ("delall" == dropdown) {
                        if (confirm("不可恢复，确认？")) {
                            $("input[name=enrolckb]:checked").each(function() {
                                ids += "," + $(this).val();
                            });
                        }
                    }
                    ...
                    form1.action = "${pageContext.servletContext.contextPath}/servlet/EnrolServlet?method=delAll";
                    form1.submit();
                });
            });
        </script>
                ...
                <div class="content-box">
                    ...
                    <div class="content-box-content">
                        <form id="form1" method="post">
                            ...
                            <input type="hidden" name="sid" value="${pu.sign}"/>
...
<!--                            <div class="notification attention png_bg"> <a href="#" class="close"><img src="${pageContext.servletContext.contextPath}/resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
                            ...
                            <table>
                                ...
                                <tbody>
                                    <c:forEach items="${pu.list}" var="enrol" varStatus="s">
                                        <tr>
                                            <td>
                                                <input type="checkbox" name="enrolckb" value="${enrol.id}"/>
                                            </td>
                                            <td>${s.count}</td>
                                            <td>${enrol.name}</td>
                                            <td>${"1"==enrol.sex?"女":"男"}</td>
<!--                                            <td>${enrol.ages}</td>
                                            <td>${enrol.phone}</td>-->
                                            <td>${enrol.education}年${enrol.specialty}月</td>
                                            <td>${enrol.tel}</td>
<!--                                            <td>${enrol.email}</td>
                                            <td>${enrol.education}</td>-->
<!--                                            <td>${enrol.specialty}</td>
                                            <td>${enrol.comname}</td>-->
                                            <!--<td>${enrol.remark}</td>-->
                                            <td>${enrol.times}</td>
                                            <td>${enrol.openid}</td>
