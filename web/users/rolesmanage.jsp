                ...
                <div class="content-box">
                    ...
                    <div class="content-box-content">
                        <div class="tab-content default-tab" id="tab2">
                            <form action="${pageContext.servletContext.contextPath}/servlet/RolesServlet?method=manage" id="form1" method="post">
                                ...
                                <fieldset>
                                    ...
                                    <p>
                                        <label>角色名</label>
                                        <input class="text-input large-input" type="text" id="name" name="name" value="${roles.name}" />
                                    </p>
                                    <p>
                                        <label>备注</label>
                                        <textarea class="text-input" id="remark" name="remark" cols="79" rows="15">${roles.remark}</textarea>
                                    </p>
                                    <p id="submit">
