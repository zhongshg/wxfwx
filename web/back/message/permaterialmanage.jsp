                    ...
                    <div class="content-box-content">
                        <div class="tab-content default-tab" id="tab2">
                            <form action="${pageContext.servletContext.contextPath}/servlet/PerMaterialServlet?method=manage" id="form1" method="post" onsubmit="return test();">
                                ...
                                <input type="hidden" id="url" name="url" value="${material.url}"/>
                                <fieldset>
                                    ...
                                    <p>
                                        <label>媒体上传</label>
                                        <iframe src="${pageContext.servletContext.contextPath}/servlet/PublicServlet?method=peruploadmaterial_init&type=${material.type}" class="text-input medium-input" width="300" height="216" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>
                                    </p>
                                    <!--                                    <p>
                                                                            <label>媒体预览</label>
                                    ...
                                    <p>
                                        <label>媒体id</label>
                                        <input class="text-input large-input datepicker" type="text" id="mediaid" name="mediaid" value="${material.mediaid}" readonly="true"/>
                                    </p>
                                    <!--                                    <p>
