        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $("#exeall").click(function() {
                    ...
                    form1.action = "${pageContext.servletContext.contextPath}/servlet/ItemsmServlet?method=delAll";
                    form1.submit();
                });
            });
        </script>
            ...
            <div id="body-wrapper">
                <div id="main-content">
                    ...
                    <ul class="shortcut-buttons-set">
                        <li><a class="shortcut-button" href="${pageContext.servletContext.contextPath}/servlet/ItemsmServlet?method=initManage&id=0"><span> 
                ...
                <div class="content-box">
                    ...
                    <div class="content-box-content">
                        <form id="form1" method="post" action="${pageContext.servletContext.contextPath}/servlet/NewsmServlet?method=change">
...
<!--                                <div class="notification attention png_bg"> <a href="#" class="close"><img src="${pageContext.servletContext.contextPath}/resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <input type="hidden" name="id" value="${newsm.id}"/>
                                        <c:forEach items="${itemsmList}" var="itemsm">
                                            <tr>
                                                <td>
                                                    <input type="checkbox" name="itemsmckb" value="${itemsm.id}" ${"1"==itemsm.selects? "checked='checked'":""}/>
                                                </td>
                                                <td>${itemsm.name}</td>
                                                <td><img src="${pageContext.servletContext.contextPath}${itemsm.img}" width="60px" height="40px"/></td>
                                                <td>${itemsm.url}</td>
                                                <td>
                                                    <a href="${pageContext.servletContext.contextPath}/servlet/ItemsmServlet?method=order&newsmid=${newsm.id}&id=${itemsm.id}&dir=0" title="Edit"><img src="${pageContext.servletContext.contextPath}/resources/images/icons/up.gif" alt="Edit" />上移</a>
                                                    <a href="${pageContext.servletContext.contextPath}/servlet/ItemsmServlet?method=order&newsmid=${newsm.id}&id=${itemsm.id}&dir=1" title="Delete"><img src="${pageContext.servletContext.contextPath}/resources/images/icons/down.gif" alt="Delete" />下移</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
