            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    $("#exeall").click(function() {
                        ...
                        if ("delall" == dropdown) {
                            if (confirm("不可恢复，确认？")) {
                                $("input[name=discussReplyckb]:checked").each(function() {
                                    ids += $(this).val() + ",";
                                });
                            }
                        }
                        ...
                        form1.action = "${pageContext.servletContext.contextPath}/servlet/DiscussServlet?method=delReplyAll";
                        form1.submit();
                    });
                });
                function test() {
    ...
    <body>
        <div id="body-wrapper">
            <form id="form1" method="post">
                ...
                <input type="hidden" id="quesid" name="quesid" value="${discussReply.quesid}"/>
                <input type="hidden" id="targetid" name="targetid" value="${discussReply.id}"/>
                ...
                <div class="content-box">
                    ...
                    <div class="content-box-content">
                        <div class="tab-content default-tab" id="tab2">
                            <form action="${pageContext.servletContext.contextPath}/servlet/DiscussServlet?method=discussReply" id="form1" method="post" onsubmit="return test();">
                                <input type="hidden" id="quesid" name="quesid" value="${discussReply.quesid}"/>
                                <input type="hidden" id="targetid" name="targetid" value="${discussReply.id}"/>
                                <input type="hidden" id="username" name="username" value="${discussReply.username}"/>
                                <input type="hidden" name="page" value="${param.page}"/>
                                <fieldset>
                                    <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
                                    <p>
                                        <label>操作员：${discussReply.username}</label>
                                    </p>
                                    <p>
                                        <label>回复内容</label>
                                        <textarea class="text-input" id="content" name="content" cols="79" rows="25">${vip.content}</textarea>
                    ...
                    K.create('textarea[name="content"]', {
                        ...
                        <div class="tab-content default-tab" id="tab1">
                            ...
                            <table>
                                ...
                                <tbody>
                                    <c:forEach items="${discussReplyList}" var="discussReply">
                                        <tr>
                                            <td>
                                                <input type="checkbox" name="discussReplyckb" value="${discussReply.id}"/>
                                            </td>
                                            <td>${discussReply.openid}</td>
                                            <td>${discussReply.content}</td>
                                            <td>${discussReply.times}</td>
                                            <!--<td>-->
                                            <!-- Icons -->
                                            <!--<a href="#" title="Edit"><img src="${pageContext.servletContext.contextPath}/resources/images/icons/pencil.png" alt="Edit" /></a> <a href="#" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a> <a href="#" title="Edit Meta"><img src="resources/images/icons/hammer_screwdriver.png" alt="Edit Meta" /></a> </td>-->
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
