        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $("#exeall").click(function() {
                    ...
                    form1.action = "${pageContext.servletContext.contextPath}/servlet/SubscriberdetailServlet?method=delAll";
                    form1.submit();
                });
            });
        </script>
                                ...
                                <tbody>
                                    <c:forEach items="${pu.list}" var="subscriberdetail" varStatus="s">
                                        <tr>
                                            ...
                                            <td>${subscriberdetail.msgtype}</td>
                                            <td>${subscriberdetail.event}</td>
                                            <td>${subscriberdetail.content}</td>
                                            <td>${subscriberdetail.remark}</td>
                                            <td>${subscriberdetail.dates}</td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
