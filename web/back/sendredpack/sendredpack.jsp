    ...
    <head>
        ...
        <jsp:include page="../../public/css.jsp"></jsp:include>
            <script type="text/javascript">
                function del(id) {
                    if (confirm("不可恢复,确认？")) {
                        window.location.href = "${pageContext.servletContext.contextPath}/servlet/SendredpackServlet?method=delete&id=" + id;
                    }
                }
        </script>
    </head>
        ...
        <div id="body-wrapper">
            <div id="main-content">
                ...
                <ul class="shortcut-buttons-set">
                    <li><a class="shortcut-button" href="${pageContext.servletContext.contextPath}/servlet/SendredpackServlet?method=initManage&id=0"><span> 
                                ...
                                <tbody>
                                    <c:forEach items="${pu.list}" var="activity">
                                        <tr>
                                            ...
                                            <td>${activity.id}</td>
                                            <td>${activity.name}</td>
                                            <!--<td>${activity.mch_billno}</td>-->
                                            <td>${"0"==activity.type?"普通红包":"拼手气红包(其他)"}</td>
                                            <!--<td>${activity.nick_name}</td>-->
                                            <td>${activity.send_name}</td>
                                            <td>${activity.money}</td>
                                            <td>${activity.num}</td>
                                            <td>${activity.wishing}</td>
                                            <td>${activity.remark}</td>
                                            <!--<td><img src="${pageContext.servletContext.contextPath}${activity.img}" width="60px" height="40px"/></td>-->
                                            <td>
                                                <!-- Icons -->
                                                <a href="${pageContext.servletContext.contextPath}/servlet/SendredpackServlet?method=initManage&id=${activity.id}&page=${pu.page}" title="Edit"><img src="${pageContext.servletContext.contextPath}/resources/images/icons/pencil.png" alt="Edit" />编辑</a> 
                                                ...
                                                <a href="${pageContext.servletContext.contextPath}/servlet/SendredpackServlet?method=sendredpack&id=${activity.id}&page=${pu.page}" title="Edit Meta"><img src="${pageContext.servletContext.contextPath}/resources/images/icons/hammer_screwdriver.png" alt="Edit Meta" />发送</a>
                                                <a href="${pageContext.servletContext.contextPath}/servlet/SendredpacklogsServlet?method=getList&mch_billno=${activity.mch_billno}" title="Edit Meta"><img src="${pageContext.servletContext.contextPath}/resources/images/icons/hammer_screwdriver.png" alt="Edit Meta" />查看</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
