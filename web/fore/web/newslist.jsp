            ...
            <tr>
                ...
                <td>
                    <c:forEach items="${mapsList}" var="map" varStatus="s">
                        <a href="${pageContext.servletContext.contextPath}ForeServlet?method=news&sid=${sid}&id=${map.id}">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ld010">
                                <tr>
                                    <td><div class="ld012_s" >
                                            ...
                                            <img src="${pageContext.servletContext.contextPath}${map.img}" height="204" style="float:${1==s.count%2?'right':'left'};"/></div></td>
                                </tr>
                                <tr>
                                    <td></td>
                                </tr>
