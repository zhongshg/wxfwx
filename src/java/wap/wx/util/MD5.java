...
public class MD5 {
     ...
     */
    public String getMD5of32(String inbuf) {
        md5Init();
    ...
    public String getMD5of16(String inbuf) {
        String tempStr = null;
        tempStr = getMD5of32(inbuf);
        return tempStr.substring(8, 24);
    ...
    /**
     * 事例： public static void main(String args[]) { MD5 m = new MD5(); if
     ...
     * System.out.println("MD5(\"message digest\"):"+m.getMD5of32("message
     * digest")); System.out.println("MD5(\"abcdefghijklmnopqrstuvwxyz\"):"+
