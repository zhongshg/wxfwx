 ...
 */
public class Wxpaynotify_urlServlet3 extends HttpServlet {
        ...
        if (null != postStr && !postStr.isEmpty()) {
            ...
            if ("SUCCESS".equals(return_code)) {
                ...
                for (Element element : elementList) {
                    ...
                    System.out.println(element.getName() + " element " + element.getText());
                    tempMap.put(element.getName(), element.getText());
                }

                String sign = wxPayUtils.getSignature(tempMap, WxReader.getWxInfo().get("key"));
                System.out.println("万巷坊支付sign " + root.elementTextTrim("sign") + " mysign " + sign);
//            if (sign.equals(root.elementTextTrim("sign"))) {
                ...
                if ("SUCCESS".equals(result_code)) {
                    ...
                    System.out.println("out_trade_no处理过没？ " + order.getFieldValue("out_trade_no"));
