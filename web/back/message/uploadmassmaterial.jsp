            ...
            $(document).ready(function() {
                $("#button").click(function() {
                    ...
                    if ("0" == newsm) {
                        ...
                        $.post("${pageContext.servletContext.contextPath}/servlet/MaterialServlet?method=uploadmassmaterial", {"newsm": newsm}, function(result) {
                            result = eval("(" + result + ")");
                            if ("invalid" == result.msg) {
                                alert("缩略图无效，请检查缩略图是否过期！");
                                return false;
                                ...
                                alert("上传成功！");
                                parent.document.getElementById("mediaid").value = result.mediaid + "," + result.times;
