<%-- 
    Document   : targetforum
    Created on : 2014-12-9, 14:08:58
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $("#exeall").click(function() {
                    ...
                    if ("delall" == dropdown) {
                        if (confirm("不可恢复，确认？")) {
                            $("input[name=forumckb]:checked").each(function() {
                                ids += $(this).val() + ",";
                            });
                        }
                    }
                    ...
                    form1.action = "${pageContext.servletContext.contextPath}/servlet/ForumServlet?method=delAll";
                    form1.submit();
                });
            });
        </script>
                ...
                <div class="content-box">
                    ...
                    <div class="content-box-content">
                        <form id="form1" method="post">
                            ...
                            <input type="hidden" name="id" value="${pu.sign}"/>
                        </form>
...
<!--                            <div class="notification attention png_bg"> <a href="#" class="close"><img src="${pageContext.servletContext.contextPath}/resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
                            ...
                            <table>
                                ...
                                <%--id,openid,name,password,hreat,img,percent,content,count,times--%>
                                <tbody>
                                    <c:forEach items="${pu.list}" var="forum" varStatus="s">
                                        <tr>
                                            <td>
                                                <input type="checkbox" name="forumckb" value="${forum.id}"/>
                                            </td>
                                            <td>${s.count}</td>
                                            <td>${forum.openid}</td>
                                            <td>${forum.ip}</td>
