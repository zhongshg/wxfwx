                ...
                <div class="content-box">
                    ...
                    <div class="content-box-content">
                        <div class="tab-content default-tab" id="tab2">
                            <form action="${pageContext.servletContext.contextPath}/servlet/TextServlet?method=manage" id="form1" method="post" onsubmit="return test();">
                                ...
                                <fieldset>
                                    ...
                                    <p>
                                        <label>标题</label>
                                        <input class="text-input large-input" type="text" id="name" name="name" value="${text.name}" />
                                        <span id="namespan" class="input-notification error png_bg"></span>
                                    </p>
                                    <p>
                                        <label>内容</label>
                                        <textarea class="text-input" id="describers" name="describers" cols="79" rows="15">${text.describers}</textarea>
                                    </p>
                                    <p id="submit">
