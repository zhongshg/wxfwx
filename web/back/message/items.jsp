    ...
    <head>
        ...
        <jsp:include page="../../public/css.jsp"></jsp:include>
            <script type="text/javascript">
                function del(id) {
                    if (confirm("不可恢复,确认？")) {
                        window.location.href = "${pageContext.servletContext.contextPath}/servlet/ItemsmServlet?method=delete&id=" + id;
                    }
                }
        </script>
    </head>
                                ...
                                <tbody>
                                    <c:forEach items="${pu.list}" var="itemsm">
                                        <tr>
                                            ...
                                            <td>
                                                <!-- Icons -->
                                                <a href="${pageContext.servletContext.contextPath}/servlet/ItemsmServlet?method=initManage&id=${itemsm.id}&page=${pu.page}" title="Edit"><img src="${pageContext.servletContext.contextPath}/resources/images/icons/pencil.png" alt="Edit" />编辑</a> 
