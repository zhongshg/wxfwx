                        ...
                        <div class="tab-content default-tab" id="tab2">
                            <form action="${pageContext.servletContext.contextPath}/servlet/MaterialServlet?method=manage" id="form1" method="post" onsubmit="return test();">
                                ...
                                <fieldset>
                                    ...
                                    <p>
                                        <label>图文上传</label>
                                        <iframe src="${pageContext.servletContext.contextPath}/servlet/MaterialServlet?method=uploadmassmaterialinit" class="text-input medium-input" width="300" height="66" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>
                                    </p>
                                    <p>
                                        <label>媒体id</label>
