				...
				<div class="content-box-content">
					<div class="tab-content default-tab" id="tab2">
						<form
							...
							<input type="hidden" id="id" name="id" value="${storetype.id}" />
							<input type="hidden" id="sid" name="sid" value="${storetype.sid}" />
							<input type="hidden" id="img" name="img" value="${storetype.img}" />
							<%--图片路径--%>
